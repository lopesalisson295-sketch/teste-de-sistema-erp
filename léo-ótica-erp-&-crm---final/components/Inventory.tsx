                ...
                <tr key={product.id} className={`group hover:bg-blue-50 transition-colors ${isLowStock ? 'bg-red-50/30' : ''}`}>
                  ...
                  <td className="px-6 py-4 text-center">
                    <div className="flex items-center justify-center gap-2">
                      <button type="button" onClick={(e) => handleEdit(product.id, e)} className="p-2 text-slate-600 hover:text-blue-600 hover:bg-blue-100 rounded-full transition-colors cursor-pointer bg-white shadow-sm border border-slate-200" title="Editar Estoque">
                        <Edit2 size={18} />
                      </button>
                      <button type="button" onClick={(e) => handleDelete(product.id, e)} className="p-2 text-slate-600 hover:text-red-600 hover:bg-red-100 rounded-full transition-colors cursor-pointer bg-white shadow-sm border border-slate-200" title="Remover">
                        <Trash2 size={18} />
                      </button>
                    </div>
                  </td>
