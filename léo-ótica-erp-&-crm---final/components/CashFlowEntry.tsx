          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
            <div className="flex gap-2 mb-6">
              <button
                ...
                className={`flex-1 py-3 rounded-lg border flex items-center justify-center gap-2 transition-all cursor-pointer ${type === 'income'
              ...
              <button
                ...
                className={`flex-1 py-3 rounded-lg border flex items-center justify-center gap-2 transition-all cursor-pointer ${type === 'expense'
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className={`w-full py-3 mt-2 rounded-lg font-bold text-white shadow-md flex items-center justify-center gap-2 transition-transform active:scale-95 cursor-pointer ${type === 'income' ? 'bg-teal-600 hover:bg-teal-700' : 'bg-red-600 hover:bg-red-700'
                  }`}
              >
                <Save size={18} />
                Salvar Lançamento
                      ...
                      <tr key={t.id} className="hover:bg-blue-50 transition-colors">
                        ...
                        <td className="px-6 py-3 text-center">
                          <button
                            ...
                            className="p-2 text-slate-600 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors cursor-pointer bg-white shadow-sm border border-slate-200"
